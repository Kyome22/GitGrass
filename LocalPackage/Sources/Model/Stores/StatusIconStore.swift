...
public final class StatusIconStore: Composable {
    ...
    private let distributedNotificationClient: DistributedNotificationClient
    ...
    public init(
        ...
        self.distributedNotificationClient = appDependencies.distributedNotificationClient
    ...
    public func reduce(_ action: Action) async {
        ...
        case let .task(screenName):
            ...
            task?.cancel()
            task = Task { [weak self, appStateClient, distributedNotificationClient] in
                await withTaskGroup(of: Void.self) { group in
                    ...
                    group.addTask { @MainActor @Sendable in
                        let publisher = distributedNotificationClient.publisher(.appleColorPreferencesChanged)
